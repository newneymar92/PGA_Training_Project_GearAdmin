...
export default function ManageForm(props: any) {
  ...
  const handleAddArrivalDate = (date: any, dateString: any) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <Form.Item
          name="description"
          label={<label style={{ color: '#FFFFFF' }}>Description</label>}
        ...
        >
          <div>
            ...
            <Input
              ...
              style={{ marginLeft: '20px', display: `${display}`, width: '250px' }}
              addonBefore={
        ...
        <Form.Item label={<label style={{ color: '#fff' }}>Arrival date</label>} name="arrivalDate">
          <div>
            <DatePicker onChange={handleAddArrivalDate} format={'YYYY-MM-DD'} />
          </div>
        </Form.Item>
        ...
        <Form.Item>
          ...
          >
            <button
              ...
              style={{ opacity: disabledButton === true ? '0.6' : '1', backgroundColor: '#f0ad4e' }}
            >
              Add Product
            </button>
          </div>
